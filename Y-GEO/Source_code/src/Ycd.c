...
static void Ycdprocess(
  ...
  INT  *i1nobf; INT  *i1ptyp; INT **i2elto;
{ INT ncelx,ncely,ncelz;  /* total number of x, y, z cells   */
  ...
  { nelemd=2*nelem;
    ...
    { if(((i1ptyp[iprop])==(YTE2TRIELS))||
            ((i1ptyp[iprop])==(YTE2PLANESTRESS)) ||
            ((i1ptyp[iprop])==(YTE2PLANESTRAIN)) ||
...
{ INT i=0;
  ...
  { Ycdprocess( /* Y elements contact detection */
    yde->melem  ,ydi->micoup,yde->nelem ,ydpe->nprop ,
    ydc->dcstec ,ydi->diezon,&ydi->diedi,
    &ydi->iiecff,
    ydn->d2ncc[0] ,ydn->d2ncc[1],ydn->d2ncc[2],ydn->d2nvc[0],ydn->d2nvc[1],
    ydn->d2nvc[2] ,yde->i1elcf,yde->i1elpr,ydi->i1iecn,ydi->i1iect,
    ydn->i1nobf ,ydpe->i1ptyp ,yde->i2elto  );
  }
