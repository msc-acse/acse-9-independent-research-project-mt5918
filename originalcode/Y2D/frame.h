...
#define DBL_SA "%+28.20le"		// added by Qinghua (output all digits)
static CHR *FLT_S[20]=
{ "%le"     ,"%+1.0le" ,"%+2.0le" ,"%+3.0le" ,"%+4.0le" ,"%+5.0le" ,
  "%+6.0le" ,"%+7.0le" ,"%+8.1le" ,"%+9.2le" ,"%+10.3le",
  "%+11.4le","%+12.5le","%+13.6le","%+14.7le","%+15.8le",
...
static CHR *INT_SS[20]=         // added by Qinghua
...
#define INTwn(file,x,ndigit)fprintf((file),(INT_SS[(ndigit)]),((x)));   // added by Qinghua
#define SINTw(file,x,ndigit)sprintf((file),(INT_S[(ndigit)]),((x))); 
#define DBLw(file,x,ndigit)fprintf((file),(DBL_S[((ndigit))]),(x));
#define DBLwa(file,x)fprintf((file),DBL_SA,(x));                        // added by Qinghua
